...
const uint64_t CRYPTONOTE_PUBLIC_ADDRESS_BASE58_PREFIX       = 39031;
...
const uint32_t MIXIN_LIMITS_V1_HEIGHT                        = 40000;
...
const char     CRYPTONOTE_NAME[]                             = "Bitrial";
...
const int      P2P_DEFAULT_PORT                              =  15897;
const int      RPC_DEFAULT_PORT                              =  15898;
...
const char     LATEST_VERSION_URL[]                          = "http://latest.bitrial.vip";
const std::string LICENSE_URL                                = "https://github.com/Watt3r/Toman/blob/master/LICENSE";
const static   boost::uuids::uuid CRYPTONOTE_NETWORK         =
{
    {  0x42, 0x69, 0x74, 0x72, 0x69, 0x61, 0x6c, 0x42, 0x69, 0x74, 0x72, 0x69, 0x61, 0x6c, 0x42, 0x42 }
};

const char* const SEED_NODES[] = {
  "185.94.99.182:15897",//ehsan
  "142.93.28.194:15897" //watter
};
} // CryptoNote
